...
namespace Drupal\search_api_ai_chatbot\Form;
...
class ChatForm extends FormBase {
  ...
  public function getFormId() {
    return 'search_api_ai_foundation_chat';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['actions']['submit'] = [
      ...
      '#attached' => [
        'library' => ['search_api_ai_chatbot/form-stream'],
      ],
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($query_vectors as $match) {
      ...
      if ($entity = $index->loadItem($match->getExtraData('drupal_entity_id'))->getValue()) {
        $content = $match->getExtraData('content');
