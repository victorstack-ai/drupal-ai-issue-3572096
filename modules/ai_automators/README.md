...
recommend that you use the [AI Automators module guide](https://project.pages.drupalcode.org/ai/modules/ai_automators/index.md) to assist with
using the module.

## Develop for it
Check the [developers guide](https://project.pages.drupalcode.org/ai/developers/developer_information.md) for information on how to develop using the
AI module.