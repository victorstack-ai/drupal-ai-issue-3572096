...
namespace Drupal\vdb_provider_pinecone\Plugin\VdbProvider;
...
use Drupal\vdb_provider_pinecone\Pinecone;
...
class PineconeProvider extends AiVdbProviderClientBase implements ContainerFactoryPluginInterface {
   ...
   *   The messenger.
   * @param \Drupal\vdb_provider_pinecone\Pinecone $pinecone
   ...
   *
   * @return \Drupal\vdb_provider_pinecone\Pinecone
   *   The Pinecone client.
   */
  ...
  public function getConfig(): ImmutableConfig {
    return $this->configFactory->get('vdb_provider_pinecone.settings');
  }
