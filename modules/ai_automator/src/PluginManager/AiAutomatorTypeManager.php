 ...
 *
 * @see \Drupal\ai_automator\Attribute\AiAutomatorType
 * @see \Drupal\ai_automator\PluginInterfaces\AiAutomatorTypeInterface
 * @see plugin_api
 */
class AiAutomatorTypeManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      ...
      $namespaces,
      $module_handler,
      'Drupal\ai_automator\PluginInterfaces\AiAutomatorTypeInterface',
      'Drupal\ai_automator\Attribute\AiAutomatorType'
    );
