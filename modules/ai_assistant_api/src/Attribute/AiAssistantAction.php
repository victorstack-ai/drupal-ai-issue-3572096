...
namespace Drupal\ai_assistant_api\Attribute;

use Drupal\Component\Plugin\Attribute\AttributeBase;
use Drupal\Core\StringTranslation\TranslatableMarkup;

/**
 * The ai assistant actions attribute.
 */
#[\Attribute(\Attribute::TARGET_CLASS)]
final class AiAssistantAction extends AttributeBase {

  /**
   * Constructs a new AiAssistantAction instance.
   *
   * @param string $id
